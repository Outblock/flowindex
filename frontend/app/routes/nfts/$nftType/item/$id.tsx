                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        {tx ? (
                          <Link to="/tx/$txId" params={{ txId: normalizeAddress(tx) }} search={{ tab: undefined }} className="font-mono text-xs text-nothing-green-dark dark:text-nothing-green hover:underline">
