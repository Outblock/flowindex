...
export interface AccountChildInfo {
    address: string;
    display?: MetadataViewsDisplay | undefined;
    factorySupportedTypes?: string[] | undefined;
    filterDetails?: any | undefined;
    managerFilterDetails?: any | undefined;
}
...
/** Generated Cadence interface */
export interface AccountOwnedInfo {
    display?: MetadataViewsDisplay | undefined;
...
/** Generated Cadence interface */
export interface AccountParentInfo {
    address: string;
    isClaimed: boolean;
}
...
`;
  ...
  public async getNftDetail(address: string, pathId: string, tokenIDs: number[]): Promise<Record<string, any>[]> {
    const code = `
import NonFungibleToken from 0xNonFungibleToken
import MetadataViews from 0xMetadataViews
import ViewResolver from 0xMetadataViews
...
`;
    let config = {
      ...
      args: (arg: any, t: any) => [
        arg(address, t.Address),
        arg(pathId, t.String),
        arg(tokenIDs.map(String), t.Array(t.UInt64)),
      ],
      limit: 9999,
    };
    config = await this.runRequestInterceptors(config);
...
`;
  ...
  public async getNftsFromCollection(address: string, storageIdentifier: string, start: number, end: number): Promise<any[]> {
    const code = `
import NonFungibleToken from 0xNonFungibleToken
import MetadataViews from 0xMetadataViews
import ViewResolver from 0xMetadataViews
...
`;
    let config = {
      cadence: code.trim(),
      name: "getNftsFromCollection",
      type: "script",
      args: (arg: any, t: any) => [
        arg(address, t.Address),
        arg(storageIdentifier, t.String),
        arg(start, t.Int),
        arg(end, t.Int),
      ],
      limit: 9999,
