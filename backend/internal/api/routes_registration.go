...
func registerFlowRoutes(r *mux.Router, s *Server) {
	...
	r.HandleFunc("/flow/transaction/{id}/enrichments", s.handleFlowGetTransactionEnrichments).Methods("GET", "OPTIONS")
...
func registerAccountingRoutes(r *mux.Router, s *Server) {
	...
	r.HandleFunc("/accounting/transaction/{id}/enrichments", s.handleFlowGetTransactionEnrichments).Methods("GET", "OPTIONS")
