...
//
// We intentionally don't mount this under `/api/*` because the portal itself uses
// `/api/search` for Fumadocs. Scalar "Try it" and spec loading use this route:
//   - /flowscan-api/openapi.yaml
//   - /flowscan-api/blocks?page=1
//
